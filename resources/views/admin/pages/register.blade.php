            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="post" action="{{ url('admin/store-user') }}" novalidate>
                   @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <div class="alert alert-danger">{{ Session::get('email_exists') }}</div>
                      @endif
                    </div>  
                    ...
                    <div class="col-12">
                      ...
                      <div class="alert alert-danger">{{ Session::get('fail_pass') }}</div>
                      @endif
                    </div>
                    <div class="col-12">
